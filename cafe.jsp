  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        ...
        <img src="images/rest1.jpg" class="card-img-top food-img" alt="Rest1"/>
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        <img src="images/rest2.jpg" class="card-img-top food-img" alt="Rest2">
        
        <div class="card-body">
          <h5 class="card-title">The Brew House</h5>
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        <img src="images/rest3.jpg" class="card-img-top food-img" alt="Rest3">
        <div class="card-body">
          <h5 class="card-title">Caffeine Corner</h5>
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        <img src="images/rest4.jpg" class="card-img-top food-img" alt="Rest4">
        <div class="card-body">
          <h5 class="card-title">Sweet Sip</h5>
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        <img src="images/rest5.jpg" class="card-img-top food-img" alt="Rest5">
        <div class="card-body">
          <h5 class="card-title">Latte Lane</h5>
